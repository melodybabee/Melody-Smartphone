    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'images/chair-alpha.png', 'Fashion'),
            _buildHero(context, 'images/binoculars-alpha.png', 'Architecture'),
            _buildHero(context, 'images/beachball-alpha.png', 'Nature'),
          ],
        ),
      ),
    );
